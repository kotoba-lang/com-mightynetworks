...
Relocated 2026-07-05 from `etzhayyim/root/20-actors/mightynetworks-compat` to
`kotoba-lang/com-mightynetworks` per the org-taxonomy library-placement rule (any
